% Autogenerated file: Mon Jul 15 14:57:37 2019
function writeCodeInfoFcn


% Load a ComponentInterface object from IR
codeIRInfoStruct = load('/home/vasi_ko/Documents/Mathworks_docs/the_world_of_tlc_and_code_gen_control/examplesOfOtherCustomTargetSupportPackages/darwinop-ens-simulink-9f4d884/untitled_darwinop_rtw/tlc/codeIRInfo.mat');
...
wr = coder.internal.writeDataInterfacesToCodeDescriptor("untitled","/home/vasi_ko/Documents/Mathworks_docs/the_world_of_tlc_and_code_gen_control/examplesOfOtherCustomTargetSupportPackages/darwinop-ens-simulink-9f4d884/untitled_darwinop_rtw") ;

fr = coder.internal.writeFunctionInterfacesToCodeDescriptor("untitled", "/home/vasi_ko/Documents/Mathworks_docs/the_world_of_tlc_and_code_gen_control/examplesOfOtherCustomTargetSupportPackages/darwinop-ens-simulink-9f4d884/untitled_darwinop_rtw") ;
...
tmpActualReturn = RTW.DataInterface.empty;
  ...
  func_Initialize_Prototype.Return     = tmpRet;
    func_Initialize_Prototype.HeaderFile = ['untitled', '.h'];
  func_Initialize_Prototype.SourceFile = ['untitled', '.cpp'];
  ...
  func_Initialize_Interface.ActualReturn = tmpActualReturn;
      ...
      func_Initialize_Prototype.Name = 'untitled_initialize';
...
tmpActualReturn = RTW.DataInterface.empty;
  ...
  func_OutputUpdate_Prototype.Return     = tmpRet;
    func_OutputUpdate_Prototype.HeaderFile = ['untitled', '.h'];
  func_OutputUpdate_Prototype.SourceFile = ['untitled', '.cpp'];
  ...
  func_OutputUpdate_Interface.ActualReturn = tmpActualReturn;
        ...
        func_OutputUpdate_Prototype.Name = 'untitled_step';
...
tmpActualReturn = RTW.DataInterface.empty;
  ...
  func_Terminate_Prototype.Return     = tmpRet;
    func_Terminate_Prototype.HeaderFile = ['untitled', '.h'];
  func_Terminate_Prototype.SourceFile = ['untitled', '.cpp'];
  ...
  time_constant = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
      func_Terminate_Interface.Timing = time_constant;
            func_Terminate_Prototype.Name = ['untitled_terminate'];
