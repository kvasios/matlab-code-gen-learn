/*
 * sfun_usb_tx.c: simulation stub for Send USB data packet
 *
 *   Copyright 2010 The MathWorks, Inc.
 */


#define S_FUNCTION_NAME  sfun_usb_tx
...
#define SIZE_DATA_PACKET 64

/*==================================================*
 * Macros to access the S-function parameter values *
 *==================================================*/
uint8_T sendBuf[NUM_OF_BD_MODES][SIZE_DATA_PACKET];
...
static void mdlRTW(SimStruct *S)
{
  ...
  {
    ssSetErrorStatus(S, "USB Tx:ParamError");
