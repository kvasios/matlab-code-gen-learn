/*
 * sfun_acceleration_sensor.c: simulation stub for HiTechnic Acceleration Sensor
 *
 *   Copyright 2010 The MathWorks, Inc.
 */


#define S_FUNCTION_NAME  sfun_acceleration_sensor
...
static void mdlRTW(SimStruct *S)
{
  ...
  {
    ssSetErrorStatus(S, "Acceleration Sensor:ParamError");
