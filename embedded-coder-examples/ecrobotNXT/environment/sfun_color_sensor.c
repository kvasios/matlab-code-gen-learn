/*
 * sfun_color_sensor.c: simulation stub for HiTechnic Color Sensor
 *
 *   Copyright 2010 The MathWorks, Inc.
 */


#define S_FUNCTION_NAME  sfun_color_sensor
...
static void mdlRTW(SimStruct *S)
{
  ...
  {
    ssSetErrorStatus(S, "HiTechnic Color Sensor:ParamError");
