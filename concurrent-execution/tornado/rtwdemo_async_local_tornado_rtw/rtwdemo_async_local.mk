...
MODEL               = rtwdemo_async_local
MODULES             = 
MAKEFILE            = rtwdemo_async_local.mk
...
S_FUNCTIONS_LIB     = $(START_DIR)/slprj/tornado/_sharedutils/rtwshared.a
SOLVER              = 
NUMST               = 2
TID01EQ             = 0
NCSTATES            = 0
MEM_ALLOC           = RT_STATIC
COMPUTER            = GLNXA64
BUILDARGS           =  TMW_EXTMODE_TESTING=0 RTWCAPIPARAMS=0 RTWCAPISIGNALS=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 OPTS="-DTID01EQ=0"
MULTITASKING        = 1
EXT_MODE            = 0
EXTMODE_TRANSPORT   = 0
EXTMODE_STATIC      = 0
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/rtwdemo_async_local_tornado_rtw \
...
%.o : $(MATLAB_ROOT)/rtw/c/tornado/devices/%.cpp
	$(CC) $(CPPFLAGS) $<
