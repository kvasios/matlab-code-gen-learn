/*
 *   robot_world_distances_sfun.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 ...
 *   C source code generated on : 29-Jun-2018 14:47:59
...
/*
   ...
   def.HeaderFiles = {'robot_world_distances.h', 'collision_api.h'};
   def.SourceFiles = {'robot_world_distances.c'};
