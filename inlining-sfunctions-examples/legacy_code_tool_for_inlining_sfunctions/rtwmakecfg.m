...
%   MATLAB file generated on : 29-Jun-2018 16:42:58
...
% Dependency info for S-function 'robot_world_distances_sfun'
info(1).SFunctionName = 'robot_world_distances_sfun';
info(1).IncPaths = {'controllers/src/collision', 'controllers/build'};
info(1).SrcPaths = {'controllers/src/collision'};
info(1).SourceFiles = {'robot_world_distances.cpp', 'collision.cpp', 'collision_api.cpp', 'math_geometry.cpp'};
info(1).Language = 'C++';
