...
#include "ext_types.h"
    ...
    extern void rtExtModeStartup(RTWExtModeInfo *ei,
                                 int_T          numSampTimes,
                                 int_T          priority);

    extern void rtExtModeCleanup(int_T numSampTimes);

    extern void rtExtModeSetPortInExtUD(const int_T port);
